    ...
    <div className="min-h-screen bg-background">
      <div className="container py-16">
        <div className="mb-16 text-center">
          <h1 className="text-4xl font-bold mb-4">Color Card Generator</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Pick any color and generate a professional color card ready for download.</p>
        </div>
